...
namespace Catan.Client.PresentationLayer
{
    class Hexagon:Texture
    {
        ...
        public Image BackgroundImage { set { this.backgroundImage = value;isBackgroundImageProccessed = false; }get { return backgroundImage; } }
        ...
        public Hexagon(float x, float y,int rowIndex, int columnIndex, float radius,Pen pen,bool isPickTop) : base(x, y,0, 0,pen)
        {
            ...
            Edges.Add(new Edge(pointsOutHex[0], pointsOutHex[1], pointsInHex[0], pointsInHex[1], pen));
            Edges.Add(new Edge(pointsOutHex[1], pointsOutHex[2], pointsInHex[1], pointsInHex[2], pen));
            Edges.Add(new Edge(pointsOutHex[2], pointsOutHex[3], pointsInHex[2], pointsInHex[3], pen));
            Edges.Add(new Edge(pointsOutHex[3], pointsOutHex[4], pointsInHex[3], pointsInHex[4], pen));
            Edges.Add(new Edge(pointsOutHex[4], pointsOutHex[5], pointsInHex[4], pointsInHex[5], pen));
            Edges.Add(new Edge(pointsOutHex[5], pointsOutHex[0], pointsInHex[5], pointsInHex[0], pen));
        }
